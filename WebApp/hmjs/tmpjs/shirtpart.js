    ...
    function openPro(winid)
    {
        ...
        if(!owin)
        {
            ...
            owin.top    = 130;
            owin.left   = 200;
            //热度：<input type="radio" id="hotlevel_0" CHECKED value="低" name="热度" onclick="ue_radiowrite(mband)"/><label for="hotlevel_0">低</label><input type="radio" id="hotlevel_1" value="中" name="热度" onclick="ue_radiowrite(mband)"/><label for="hotlevel_1">中</label><input type="radio" '
            //+' id="hotlevel_2" value="高" name="热度" onclick="ue_radiowrite(mband)" /><label for="hotlevel_2">高</label></b>            
            var hot=''
//            +'　　样衣：<input datasrc="#商品资料分部Tab" datafld="样衣" class="xlandradio" type="checkbox" />'
//            +'　拍照：<input datasrc="#商品资料分部Tab" datafld="拍照" class="xlandradio" type="checkbox" />'
            owin.title  = "商品详细资料－【创建日期："+"<span datasrc='#商品资料分部Tab' datafld='创建日期_格式'></span>" +"/ 更新日期：<span datasrc='#商品资料分部Tab' datafld='更新日期_格式'></span>】　"+hot;
            owin.text   = str;
            gband.show   = true;
    ...
    function strfind(winid,gridname,bandname)
    {
        ...
        var s= '<fieldset style="padding: 3px;;width:99%"><legend><font face="微软雅黑">主要信息：</font></legend>\
            ...
            <input datasrc="#商品资料分部Tab" datafld="名称" class="xlandinput" style="WIDTH: 90%;" /><font face="Wingdings" color="#ff0000">v</font></td>\
            <td align="right" width="40">款号：</td><td width="100">\
            <input datasrc="#商品资料分部Tab" datafld="款号" class="xlandinput" style="width:80%;" type="text"  /><font face="Wingdings" color="#ff0000">v</font></td>\
            <td align="right" width="40">编号：</td><td width="60">\
            <input datasrc="#商品资料分部Tab" datafld="商品编号" class="xlandinput" style="width:100%;" type="text"  /></td>\
            <td align="right" width="40">失效：</td><td width="20">\
            <input datasrc="#商品资料分部Tab" datafld="失效" class="xlandradio" type="checkbox" /></td>\
            ...
            <fieldset style="float:left;padding: 3px;height:170;width:69%"><legend><font face="微软雅黑">选择尺码标准：</font><input class="xlandinput" style="width:100px" datasrc="#商品资料分部Tab" datafld="尺码标准"  onafterupdate="extitle()" /><input title="要选择吗，点我一下..." class="txtbtn" type=button value="..."  style="margin-left:-24px;margin-top:2px;width:22px;height:16; position:absolute" onclick="Xcbo();"/></legend><div id="dvSubTab" style="width:100%;height:95%"></div></fieldset>\
            <fieldset style="float:right;padding: 2px;height:70;width:29%"><legend><font face="微软雅黑">吊牌信息：</font></legend>'+'<textarea name="S1"  class="xlandinput" datasrc="#商品资料分部Tab" datafld="吊牌信息" style="width:176;height:70" ></textarea></fieldset>\
            <fieldset style="float:right;padding: 2px;height:79;width:29%"><legend><font face="微软雅黑">洗水唛信息：</font></legend>'+'<textarea name="S1"  class="xlandinput" datasrc="#商品资料分部Tab" datafld="洗水唛信息" style="width:176;height:70" ></textarea></fieldset>\
            </div>';
        return s;
    }
...
function secBoard(n) {
    ...
    switch(n)
    {
        ...
        case 1:
            ...
            sizeband.barcode='<button class=txtbtn onclick="slsizeinfo()" ><img src="images/buy1.gif" />选择...</button>';
...
function ue_stat(isprint)
{
    ...
    function sizestrfind(winid,gridname,bandname)
    {
        if(!bandname) bandname="";
        var s= '<fieldset style="padding: 5px;;width:98%"><legend>查询：</legend>\
        【<a href="#" onclick=sizeoklocate("'+winid+'","'+gridname+'","'+bandname+'","无此产品！")>确定</a>】</fieldset>';
