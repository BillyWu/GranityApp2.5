...
function DrawContextMenu(){
  ...
  /*item = new contextItem("新建流程图", "workflow/image/new.gif", "mnuNewFlow();", "menu");
  popmnu.addItem(item);

  item = new contextItem("打开流程图", "workflow/image/open.gif", "mnuOpenFlow();", "menu");
  popmnu.addItem(item);*/

  /*item = new contextItem("保存流程图", "workflow/image/save.gif", "mnuSaveFlow();", "menu");
  popmnu.addItem(item);

  item = new contextItem("流程图属性", "workflow/image/edit.gif", "mnuEditFlow();", "menu");
  popmnu.addItem(item);*/

  /*item = new contextItem("重新载入流程图", "workflow/image/refresh.gif", "mnuReloadFlow();", "menu");
  popmnu.addItem(item);

  item = new contextItem("", "", "", "separator");
  popmnu.addItem(item);

  item = new contextItem("新建[任务]", "workflow/image/add_proc.gif", "mnuAddProc();", "menu");
  popmnu.addItem(item);

  item = new contextItem("新建[路径]", "workflow/image/add_step.gif", "mnuAddStep();", "menu");
  popmnu.addItem(item);

  item = new contextItem("复制选中任务", "workflow/image/copy.gif", "mnuCopyProc();", "menu");
  popmnu.addItem(item);

  item = new contextItem("编辑选中对象", "workflow/image/edit_obj.gif", "mnuEditObj();", "menu");
  popmnu.addItem(item);*/

  item = new contextItem("删除选中对象", "workflow/image/del_obj.gif", "mnuDelObj();", "menu");
  popmnu.addItem(item);

  /*item = new contextItem("移到最前面", "workflow/image/front.gif", "mnuSetZIndex('F');", "menu");
  popmnu.addItem(item);

  item = new contextItem("移到最后面", "workflow/image/back.gif", "mnuSetZIndex('B');", "menu");
  popmnu.addItem(item);*/
