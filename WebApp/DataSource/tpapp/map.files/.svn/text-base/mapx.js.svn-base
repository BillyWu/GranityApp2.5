...
{
	var grpObj = document.getElementById("group");	
	var oshape = grpObj.appendChild(document.createElement('<v:shape id="vml21" style="Z-INDEX:'+obj_zIndex+';LEFT:'+ vleft +'px;WIDTH:60px;TOP:'+ vtop +'px;HEIGHT:20px" inset="1px,1px,1px,1px" coordsize="1000,680"  filled="f" >'));
	var oText = oshape.appendChild(document.createElement('<DIV id="Div37" style="font-family: Microsoft Sans Serif;FONT-SIZE: 7.8pt; CURSOR: hand; COLOR: black; TEXT-ALIGN: left">'));
 	oText.innerText=val;
}
...
function createAddress()
{
    ...
    if(!parent.document.UnitItem.Bands[0])   return;
