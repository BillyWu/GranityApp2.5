...
TToolBox.prototype.hideBox = function(){
  ...
  oImg.src = "images/" + this.TitleBtn[0] + ".gif";
  oImg.title = "单击展开工具栏";
...
TToolBox.prototype.showBox = function(){
  ...
  oImg.src = "images/" + this.TitleBtn[1] + ".gif";
  oImg.title = "单击收缩工具栏";
...
TToolBox.prototype.toString = function(){
  ...
  if(this.Dir == "down"){
    S += '<tr id="'+this.ID+'_title" height="'+this.TitleHeight+'"  style="cursor:move;"><td colspan="2" title="双击可以展开/收缩工具栏，按住左键移动位置" '+
    'ondblclick="'+this.ID+'.showHideTool();"><table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0"><tr><td width="99%" id="tdTitle" moveType="m">&nbsp;<font color="white" moveType="m">' + this.Caption + '</font></td><td width="1%"><img id="'+this.ID+'_img" title="单击收缩工具栏" src="images/' + this.TitleBtn[1] + '.gif" style="cursor:hand;" onclick="'+this.ID+'.showHideTool();" height="14" width="14" border="0"></td></tr></table></td></tr>' +
    ...
    '<tr id="'+this.ID+'_content"><td valign="top">' + this.Content + '&nbsp;</td><td width="2" style="cursor:E-resize;" moveType="e"></td></tr>' +
    '<tr id="'+this.ID+'_title" height="'+this.TitleHeight+'"  style="cursor:move;"><td colspan="2" title="双击可以展开/收缩工具栏，按住左键移动位置" '+
    'ondblclick="'+this.ID+'.showHideTool();"><table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0"><tr><td width="99%" moveType="m">&nbsp;<font color="#FFFFFF" moveType="m">' + this.Caption + '</font></td><td width="1%"><img id="'+this.ID+'_img" title="单击收缩工具栏" src="images/' + this.TitleBtn[1] + '.gif" style="cursor:hand;" onclick="'+this.ID+'.showHideTool();" height="14" width="14" border="0"></td></tr></table></td></tr>';
  S += '</table>';
  return S;
}
...
TToolPanel.prototype.toString = function(){
  S = '<table id="'+this.ID+'" class="toolbox" style="position:absolute;left:' + this.Left + 'px;top:' + this.Top + 'px;width:' + 
    this.Width + 'px;height:' + this.Height + 'px;z-index:3000" cellspacing="0" cellpadding="0" border="0" onmousedown="'+this.ID+'.mouseDown();" '+
    'onmousemove="'+this.ID+'.mouseMove();" onmouseup="'+this.ID+'.mouseUp();">' +
    '<tr><td width="2"></td><td width="10" style="cursor:move;" moveType="m"><img moveType="m" src="images/play.gif" border="0"></td><td>' + this.Content + '</td></tr>' +
    '</table>';
  return S;
}

//在工具条上按下mouse,控制工具体的移动
