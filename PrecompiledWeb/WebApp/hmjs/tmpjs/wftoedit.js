    ...
    function ue_submit()
    {
        ...
        if($band("gonodes").Val("表单部门")!="")
            ToolUtil.setParamValue($XD(), "单位", mband.Val($band("gonodes").Val("表单部门")),"string", "P", null,"C");
    ...
    function tm_selectgoods(title,srcitem,mitem,destitem,w,h,spos,callback)
    {
        ...
        var str = strfind("wingoods","dvgoods", srcitem, destitem,callback,mitem,spos);
