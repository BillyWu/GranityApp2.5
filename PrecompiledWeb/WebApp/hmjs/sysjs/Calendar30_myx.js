...
function writeIframe()
{
    ...
    ".bg{  color: white; cursor: default; background-color: "+ WebCalendar.darkColor +";}"+
    "table#tableMain{ width: 142; height: 170;}"+
    ...
    "input{ border: 0px solid "+ WebCalendar.darkColor +"; font-family:宋体; font-size:9pt;padding-top: 0px; height: 18; cursor: hand;"+
    "       color:"+ WebCalendar.fwordColor +"; background-color: "+ WebCalendar.btnBgColor +"}"+
    "</style></head><body onselectstart='return false' style='margin: 0px' oncontextmenu=''><form name=meizz>";
    ...
    "<table id=tableMain class=bg border=1 cellspacing=0 cellpadding=0>"+
    "<tr><td width=140 height=19 bgcolor='"+ WebCalendar.darkColor +"'>"+
    "    <table width=140 id=tableHead border=0 cellspacing=1 cellpadding=0><tr align=center>"+
    "    <td width=15 height=19 class=bg title='向前翻 1 月&#13;快捷键：←' style='cursor: hand' onclick='parent.prevM()'><b>&lt;</b></td>"+
    "    <td width=60 id=meizzYearHead  style='color: #FFFFFF;' title='点击此处选择年份' onclick='parent.funYearSelect(parseInt(this.innerText, 10))'"+
    ...
    "    <td width=50 id=meizzYearMonth style='color: #FFFFFF;' title='点击此处选择月份' onclick='parent.funMonthSelect(parseInt(this.innerText, 10))'"+
    "        onmouseover='this.bgColor=parent.WebCalendar.darkColor; this.style.color=parent.WebCalendar.lightColor'"+
    "        onmouseout='this.bgColor=parent.WebCalendar.darkColor; this.style.color=parent.WebCalendar.lightColor'></td>"+
    ...
    "    <table id=tableDay height=120 width=140 border=0 cellspacing=1 cellpadding=0>";
         ...
         WebCalendar.btnBgColor +";cursor: hand; padding-top: 1px;  border: 0;width:50' onfocus='this.blur()'"+
