...
namespace Granity.communications
{
    ...
    public class CommandBase
    {
        ...
        public bool IsResponseHandle
        {
            get { return null != this.ResponseHandle; }
        }
        ...
        public CmdState CheckState()
        {
            ...
            else if (this.sendDatetime > this.responseDatetime && this.timeOut > TimeSpan.Zero && this.timeOut<TimeSpan.MaxValue
