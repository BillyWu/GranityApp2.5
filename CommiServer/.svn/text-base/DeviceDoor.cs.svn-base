...
namespace Granity.commiServer
{
    ...
    public class DeviceDoor : DeviceBase
    {
        ...
        {
            Debug.WriteLine(DateTime.Now.ToString("HH:mm:ss.fff") + " 火警：" + cardnum + "  " + statecode + "  " + idxdoor);
            myLog.WriteLine(DateTime.Now.ToString("HH:mm:ss.fff") + " 火警：" + cardnum + "  " + statecode + "  " + idxdoor);
